...
% Πορεία σύγκλισης.
figure('Name', 'Thema 4: Projected Steepest Descent', 'NumberTitle', 'off');
...
[X, Y] = meshgrid(linspace(-15, 20, 100), linspace(-15, 20, 100));
Z = (1/3).*X.^2 + 3.*Y.^2;
...
text(bar_x_k(1)-4, bar_x_k(2)-2, 'Projection (\bar{x}_k)', 'Color', 'm', 'FontSize', 10, 'FontWeight', 'bold');
